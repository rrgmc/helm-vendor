...
// sympathWalk walks the file tree rooted at root, calling walkFn for each file or directory
...
// output deterministic but means that for very large directories sympathWalk can be
// inefficient. sympathWalk follows symbolic links.
func sympathWalk(root string, walkFn filepath.WalkFunc) error {
